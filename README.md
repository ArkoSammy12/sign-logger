...
If you would like to report a bug, or make a suggestion, you can do so via the mod's [issue tracker](https://github.com/ArkoSammy12/sign-logger/issues) or join my [Discord server](https://discord.gg/wScNgcvJ3y). 
