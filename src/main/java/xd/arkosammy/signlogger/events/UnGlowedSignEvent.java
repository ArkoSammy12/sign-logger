...
public record UnGlowedSignEvent(ServerPlayerEntity author, BlockPos blockPos, RegistryKey<World> worldRegistryKey, LocalDateTime timestamp, boolean isFrontSide) implements SignEditEvent {
    @Override
    ...
    public String getEventType() {
        return SignEditEvents.UNGLOWED_SIGN.getEventTypeString();
    }
    ...
    public String toString(){
        ...
        return String.format("[%s] %s removed the glow effect from the %s-side of a sign at %s in %s",
